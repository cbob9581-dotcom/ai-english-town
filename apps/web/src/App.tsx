...
export default function App() {
  ...
  const { micOn, status, turns, companion, lastGesture, discovered, toggleDiscover, start, stop, beginUtterance, interrupt, askCompanion, requestScene, hintScene, focusNpc } = useVoiceRound('sess-1', `ws://${location.hostname}:8000/ws/sessions/sess-1`);
    ...
    <div style={{ height: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, padding: 16, position: 'relative' }}>
        <SceneViewport
          ...
          onHint={hintScene}
          onNpcClick={focusNpc}
          onEntityClick={(e) => { toggleDiscover(e.id); setFocusEntity(e); }}
